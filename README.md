...
11. [string字符串与int互相转化:atio()](https://www.cnblogs.com/smile233/p/8379802.html)
12. [string的find()函数](https://www.cnblogs.com/zpcdbky/p/4471454.html):唯一的返回类型:size_type，即一个无符号整数（按打印出来的算）。若查找成功，返回按查找规则找到的第一个字符或子串的位置；若查找失败，返回npos，即-1(打印出来为4294967295)
